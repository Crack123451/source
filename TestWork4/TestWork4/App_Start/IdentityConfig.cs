...
namespace TestWork4
{
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            string accountSid = "AC62e8bdbae0afec643530045c4e926a84";

            string authToken = "696f00c9a3d7092d1741cd87328f262e";

            string twilioPhoneNumber = "+13012593516";
