...
namespace Recognizer
{
	internal static class Program
	{
		...
		{
			return ConvertToBitmap(array.GetLength(0), array.GetLength(1), (x, y) => Color.FromArgb(array[x, y].R, array[x, y].G, array[x, y].B));
		}
		...
		{
            var t = ThresholdFilterTask.ThresholdFilter(new double[,] { { 1 },{ 2 } }, 1);
